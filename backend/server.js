...
app.use('/api/aei', require('./routes/aei'));
app.use('/api/incidents', require('./routes/incidents'));
app.use('/api/habilitations', require('./routes/habilitations'));
app.use('/api/indicateurs-env', require('./routes/indicateurs_env'));
app.use('/api/conformites', require('./routes/conformites'));
